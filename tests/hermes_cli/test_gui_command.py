...
@pytest.fixture(autouse=True)
def _stable_linux_sandbox_strategy(monkeypatch):
    """Keep generic launcher tests platform-neutral; WSL has a focused test."""
    monkeypatch.setattr(cli_main, "_desktop_linux_wsl_uses_userns_sandbox", lambda: False)
