...
def test_prompt_submit_golden_transcript_matches_flag_off_and_on(monkeypatch):
    ...
    monkeypatch.setattr(server, "_begin_turn_performance", lambda *_a, **_kw: None)
    monkeypatch.setattr(server, "_record_first_token_performance", lambda *_a, **_kw: None)
    monkeypatch.setattr(server, "_finish_turn_performance", lambda *_a, **_kw: None)
