...
// Sessions are navigation, not a compact tool palette. Ordinary conversation
// names should remain scannable without immediately truncating.
export const SIDEBAR_DEFAULT_WIDTH = 280
export const SIDEBAR_MAX_WIDTH = 400
// Keep the utility file rail compact; the wider default is only for conversations.
