...
export function ChatSidebar({
  ...
  return (
    <Sidebar
      ...
      collapsible="none"
    >
      <SidebarContent className="gap-0 overflow-hidden bg-transparent px-3.5">
        <div className="shrink-0 px-1 pb-3 pt-[calc(var(--titlebar-height)+0.75rem)]">
          <div className="flex h-11 items-center gap-3 rounded-xl px-2">
            <div className="grid size-9 shrink-0 place-items-center rounded-xl bg-(--theme-primary) text-[0.9375rem] font-bold text-white shadow-sm">
              H
            </div>
            <div className="min-w-0 flex-1">
              <div className="truncate text-[0.9375rem] font-semibold tracking-[-0.02em] text-foreground">Hermes</div>
              <div className="truncate text-[0.6875rem] leading-4 text-(--ui-text-tertiary)">Local agent workspace</div>
            </div>
            <Codicon className="text-(--ui-text-quaternary)" name="chevron-down" size="0.875rem" />
          </div>
        </div>
        <SidebarGroup className="shrink-0 p-0 pb-3">
          <SidebarGroupContent>
                ...
                const button = (
                  <SidebarMenuButton
                    ...
                    className={cn(
                      ...
                      // thread.tsx.
                      'flex h-10 w-full justify-start gap-3 rounded-xl border border-transparent px-3 text-left text-[0.9375rem] font-medium text-(--ui-text-secondary) transition-colors duration-100 ease-out [-webkit-app-region:no-drag] hover:bg-(--ui-control-hover-background) hover:text-foreground hover:transition-none',
                      active &&
                    ...
                    type="button"
                  >
                    <item.icon className="size-[1.05rem] shrink-0 text-[color-mix(in_srgb,currentColor_72%,transparent)]" />
        ...
        {showSessionSections && (
          <div className="shrink-0 px-1 pb-3 pt-1.5">
            <SearchField
        ...
        <div className="shrink-0 border-t border-(--ui-stroke-tertiary) px-1 pb-2 pt-2">
          <div className="mb-1 px-2 text-[0.6875rem] font-medium text-(--ui-text-quaternary)">Profiles</div>
          <div className="min-h-9 rounded-lg px-1 py-1 hover:bg-(--ui-control-hover-background)">
            <ProfileRail />
          </div>
        </div>
      </SidebarContent>
