...
const rowMinH = 'min-h-9'
const rowPadX = 'pl-2.5 pr-1.5'
const rowGap = 'gap-2'
const rowLead = 'grid size-4 shrink-0 place-items-center'
const rowInset = cn(rowPadX, rowGap, 'flex h-full min-w-0 items-center self-stretch py-1')
const rowLabel = 'min-w-0 truncate text-[0.875rem] leading-snug text-(--ui-text-secondary)'
...
export function SidebarDateDivider({
  ...
  return (
    ...
    <div className={cn('group/workspace flex select-none items-center gap-2 px-2.5 pb-1 pt-3', className)} {...props}>
      <span className="shrink-0 text-[0.6875rem] font-medium tracking-[-0.01em] text-(--ui-text-quaternary)">
        {label}
      </span>
