            ...
            <div className="relative w-full rounded-[inherit]">
              ...
              <div
                className={cn(
                  ...
                  'group/composer-surface relative z-4 isolate grid grid-cols-[minmax(0,1fr)] grid-rows-[auto_1fr] overflow-hidden rounded-[inherit] border border-[color-mix(in_srgb,var(--dt-composer-ring)_calc(24%*var(--composer-ring-strength)),var(--dt-input))] shadow-[0_10px_34px_color-mix(in_srgb,#000_10%,transparent),0_2px_8px_color-mix(in_srgb,#000_6%,transparent)]',
