...
export const USER_BUBBLE_BASE_CLASS =
  'composer-human-message standalone-glass relative ml-auto flex w-fit min-w-0 max-w-[min(88%,44rem)] flex-col gap-1.5 overflow-y-auto rounded-[1.125rem] border bg-(--dt-user-bubble) px-4 py-2.5 text-left shadow-[0_1px_2px_color-mix(in_srgb,#000_5%,transparent)] [-webkit-app-region:no-drag]'
