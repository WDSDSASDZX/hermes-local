...
export interface Translations {
  ...
  commandCenter: {
    ...
    overview: {
      ...
      liveAgents: string
      agentsDetail: string
      agentsFailed: (count: number) => string
    ...
    sections: Record<'maintenance' | 'overview' | 'sessions' | 'system' | 'usage', string>
    sectionDescriptions: Record<'maintenance' | 'overview' | 'sessions' | 'system' | 'usage', string>
