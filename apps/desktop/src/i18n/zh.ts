...
export const zh: Translations = {
  ...
  commandCenter: {
    ...
    archivedChats: '已归档对话',
    overview: {
      title: '你的 Agent 工作区，一眼看全',
      subtitle: '在一个界面里调度任务、配置 Agent、调整模型路由并追踪实时运行。',
      operational: 'Hermes 运行正常',
      attention: 'Hermes 需要检查',
      refresh: '刷新',
      refreshing: '刷新中',
      gateway: '网关',
      online: '在线',
      offline: '离线',
      gatewayReady: '模型与工具请求已就绪',
      gatewayUnavailable: '请到系统面板检查',
      activeSessions: '活跃会话',
      sessionsDetail: 'Hermes 当前持有的对话',
      liveAgents: '运行中的 Agent',
      agentsDetail: '排队或执行中的子 Agent',
      agentsFailed: count => `有 ${count} 个失败的 Agent 需要检查`,
      fallbackModels: '回退路由',
      fallbackReady: '按顺序执行的模型恢复链',
      fallbackEmpty: '尚未配置模型回退链',
      workspaces: '工作区',
      workspacesDetail: '把分散设置整理成四个专注的工作界面。',
      tasks: '任务看板',
      tasksDetail: '规划、分配并跟踪多 Agent 任务。',
      tasksUnavailable: '请先在设置中启用 Kanban 插件以使用任务编排。',
      profiles: 'Agent 工作室',
      profilesDetail: '组合模型、技能、工具集与 MCP 服务，创建不同 Agent。',
      models: '模型路由',
      modelsDetail: '设置主模型和按顺序执行的自动回退链。',
      traces: '实时运行',
      tracesDetail: '查看子 Agent 进度、工具、词元、文件和错误。',
      recentSessions: '最近会话',
      fallbackChain: '模型回退链',
      configure: '配置',
      defaultModel: '默认模型',
      messages: '条消息',
      noSessions: '暂无会话。开始一次对话后会显示在这里。',
      noFallbacks: '尚未配置回退路由。添加后可在上游故障时自动继续任务。'
    },
    sections: { maintenance: '维护', overview: '概览', sessions: '会话', system: '系统', usage: '用量' },
    sectionDescriptions: {
      maintenance: '诊断、备份、维护器与记忆数据',
      overview: '任务、Agent、模型路由与实时运行',
      sessions: '搜索与管理会话',
      system: '状态、日志与系统操作',
  ...
  shell: {
    ...
    statusbar: {
      ...
      turnRunning: '运行中',
      contextUsage: '上下文用量',
      performanceTitle: '运行追踪',
      performanceScope: '会话累计值 · 单次响应在回合结束后冻结',
      contextUsagePanel: {
        categories: {
          conversation: '对话',
          mcp: 'MCP',
