...
export const en: Translations = {
  ...
  commandCenter: {
    ...
    archivedChats: 'Archived chats',
    overview: {
      title: 'Your agent workspace, at a glance',
      subtitle: 'Run tasks, shape agent profiles, tune model routing, and inspect live work from one place.',
      operational: 'Hermes is operational',
      attention: 'Hermes needs attention',
      refresh: 'Refresh',
      refreshing: 'Refreshing',
      gateway: 'Gateway',
      online: 'Online',
      offline: 'Offline',
      gatewayReady: 'Ready for model and tool traffic',
      gatewayUnavailable: 'Check the system panel',
      activeSessions: 'Active sessions',
      sessionsDetail: 'Conversations currently held by Hermes',
      liveAgents: 'Live agents',
      agentsDetail: 'Queued or running subagents',
      agentsFailed: count => `${count} failed agent${count === 1 ? '' : 's'} need review`,
      fallbackModels: 'Fallback routes',
      fallbackReady: 'Ordered model recovery chain',
      fallbackEmpty: 'No fallback chain configured',
      workspaces: 'Workspaces',
      workspacesDetail: 'Four focused surfaces instead of scattered settings.',
      tasks: 'Task board',
      tasksDetail: 'Plan, assign, and follow multi-agent work.',
      tasksUnavailable: 'Enable the Kanban plugin in Settings to use task orchestration.',
      profiles: 'Agent studio',
      profilesDetail: 'Create profiles and combine models, skills, tools, and MCP servers.',
      models: 'Model routing',
      modelsDetail: 'Set the primary model and an ordered fallback chain.',
      traces: 'Live runs',
      tracesDetail: 'Inspect subagent progress, tools, tokens, files, and failures.',
      recentSessions: 'Recent sessions',
      fallbackChain: 'Model fallback chain',
      configure: 'Configure',
      defaultModel: 'Default model',
      messages: 'messages',
      noSessions: 'No sessions yet. Start a conversation to see it here.',
      noFallbacks: 'No fallback routes configured. Add one to keep work moving during provider failures.'
    },
    sections: {
    ...
    sectionDescriptions: {
      ...
      overview: 'Tasks, agents, model routing, and live work',
  ...
  shell: {
    ...
    statusbar: {
      ...
      togglePerformance: 'Runtime trace',
      ...
      performanceTitle: 'Runtime trace',
      performanceScope: 'Session totals · last response freezes when the turn completes',
      contextUsagePanel: {
        categories: {
