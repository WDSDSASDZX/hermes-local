...
def _normalize_custom_provider_entry(
    ...
    *,
    ...
    anthropic_auth = entry.get("anthropic_auth")
    if isinstance(anthropic_auth, str) and anthropic_auth.strip().lower() in {
        "auto", "x_api_key", "bearer"
    }:
        normalized["anthropic_auth"] = anthropic_auth.strip().lower()
