...
export const api = {
  ...
  getRelayProviders: () =>
    fetchJSON<CustomEndpointsResponse>("/api/providers/custom-endpoints"),
  saveRelayProvider: (body: CustomEndpointUpdate) =>
    fetchJSON<{ ok: boolean; id: string; message?: string }>(
      "/api/providers/custom-endpoints",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  validateRelayProvider: (body: CustomEndpointUpdate) =>
...
export type AnthropicAuthMode = "auto" | "x_api_key" | "bearer";
...
export interface CustomEndpoint {
  ...
  anthropic_auth: AnthropicAuthMode;
